...
public class ProcessedEventService {
    ...
    /**
     * Atomically claims the given event for processing by inserting its identifier into the dedupe table.
     *
     * @param event the integration event to claim for processing
